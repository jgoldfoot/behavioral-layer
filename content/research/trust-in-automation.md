...
status: live
tags: [trust, reliance, human-factors, automation, human-agent-interaction]
---
...
You are not just shipping capability; you are shipping the signals a person uses to decide when to lean on it. The review's conceptual model covers "the dynamics of trust, the role of context, and the influence of display characteristics": what the interface shows shapes reliance, which is the human-factors ancestor of [[confidence-and-disclosure|Confidence and Disclosure]] design.
...
Primary: [Trust in Automation: Designing for Appropriate Reliance](https://journals.sagepub.com/doi/10.1518/hfes.46.1.50_30392) (Lee and See, Human Factors 46(1), 50-80, 2004). DOI: [10.1518/hfes.46.1.50_30392](https://doi.org/10.1518/hfes.46.1.50_30392).

## Related

- [[cognitive-forcing-functions|Cognitive Forcing Functions]] - overreliance measured, and one design lever that reduced it
- [[human-ai-complementarity|Human-AI Complementarity]] - what appropriate reliance buys: teams that beat either party alone
- [[trust-scaffolding|Trust Scaffolding]] - the site's working concept for building reliance deliberately
